...
public class Canteen_Composing_Complaints extends AppCompatActivity {
    ...
    CanteenComplaints member;
    String uid;

    // To Here

//    DatabaseReference database = FirebaseDatabase.getInstance().getReference();
//    DatabaseReference userdatabase =database.child("Complaints").child("Canteen Complaints");

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_canteen__composing__complaints);
        ...
        btnsubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (complaints != null){
                    member.setCanteencomplaints(complaints);
                    ...
                    Toast.makeText(Canteen_Composing_Complaints.this, "Submitted", Toast.LENGTH_SHORT).show();


                }else {

                    Toast.makeText(Canteen_Composing_Complaints.this, "Add a complaint first", Toast.LENGTH_SHORT).show();
                }
//                if (v.getId()==R.id.submitbtn)
//                {
//                    String canteencomplaints=txtcompose.getText().toString();
//                    if (TextUtils.isEmpty(canteencomplaints))
//                    {
...
//                        CanteenComplaints canteenComplaints = new CanteenComplaints(canteencomplaints);
//                        userdatabase.child(ukey).setValue(canteenComplaints);
//
//                        finish();
//
//
                ...
                .addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.getResult().exists()){
                            ...
                            Toast.makeText(Canteen_Composing_Complaints.this, "Error", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
